# Vegas + Lit + TypeScript

A minimal Lit and Google Apps Script project created with `create-vegas`.
...
Start editing `src/client/index.html`. The Lit component is in `src/client/client.ts`, and the Apps Script server entry is `src/server/Code.ts`.
