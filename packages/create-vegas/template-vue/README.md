# Vegas + Vue + TypeScript

A minimal Vue and Google Apps Script project created with `create-vegas`.
...
Start editing `src/client/components/HelloWorld.vue`. The Apps Script server entry is `src/server/Code.ts`.
