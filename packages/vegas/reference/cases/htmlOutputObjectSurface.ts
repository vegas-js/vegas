...
function describeHtmlOutput(value: object) {
  return {
    type: typeof value,
    ...
    methodOwnership: {
      addMetaTag: describePropertyOwnership(value, "addMetaTag"),
      append: describePropertyOwnership(value, "append"),
      appendUntrusted: describePropertyOwnership(value, "appendUntrusted"),
      asTemplate: describePropertyOwnership(value, "asTemplate"),
      clear: describePropertyOwnership(value, "clear"),
      getAs: describePropertyOwnership(value, "getAs"),
      getBlob: describePropertyOwnership(value, "getBlob"),
      getContent: describePropertyOwnership(value, "getContent"),
      getFaviconUrl: describePropertyOwnership(value, "getFaviconUrl"),
      getHeight: describePropertyOwnership(value, "getHeight"),
      getMetaTags: describePropertyOwnership(value, "getMetaTags"),
      getTitle: describePropertyOwnership(value, "getTitle"),
      getWidth: describePropertyOwnership(value, "getWidth"),
      getXFrameOptionsMode: describePropertyOwnership(value, "getXFrameOptionsMode"),
      setContent: describePropertyOwnership(value, "setContent"),
      setFaviconUrl: describePropertyOwnership(value, "setFaviconUrl"),
      setHeight: describePropertyOwnership(value, "setHeight"),
      setSandboxMode: describePropertyOwnership(value, "setSandboxMode"),
      setTitle: describePropertyOwnership(value, "setTitle"),
      setWidth: describePropertyOwnership(value, "setWidth"),
      setXFrameOptionsMode: describePropertyOwnership(value, "setXFrameOptionsMode"),
...
export function captureReferenceHtmlOutputObjectSurface() {
  ...
  return describeHtmlOutput(output);
}
