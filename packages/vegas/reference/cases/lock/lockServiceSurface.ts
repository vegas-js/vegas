...
export function captureReferenceLockServiceSurface() {
  const globals = globalThis as unknown as Record<string, unknown>;
  const lockService = globals.LockService;

  if (
    lockService === null ||
    (typeof lockService !== "object" && typeof lockService !== "function")
  ) {
    return {
      type: typeof lockService,
      properties: null,
  ...
  return {
    type: typeof lockService,
    properties: describeProperties(lockService),
    prototypeIsObjectPrototype: Object.getPrototypeOf(lockService) === Object.prototype,
    stringify: String(lockService as any),
  };
}
