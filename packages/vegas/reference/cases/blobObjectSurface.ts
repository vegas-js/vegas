...
function describeBlob(value: object) {
  return {
    ...
    methodOwnership: {
      copyBlob: describePropertyOwnership(value, "copyBlob"),
      getAllBlobs: describePropertyOwnership(value, "getAllBlobs"),
      getAs: describePropertyOwnership(value, "getAs"),
      getBlob: describePropertyOwnership(value, "getBlob"),
      getBytes: describePropertyOwnership(value, "getBytes"),
      getContentType: describePropertyOwnership(value, "getContentType"),
      getDataAsString: describePropertyOwnership(value, "getDataAsString"),
      getName: describePropertyOwnership(value, "getName"),
      isGoogleType: describePropertyOwnership(value, "isGoogleType"),
      setBytes: describePropertyOwnership(value, "setBytes"),
      setContentType: describePropertyOwnership(value, "setContentType"),
      setContentTypeFromExtension: describePropertyOwnership(value, "setContentTypeFromExtension"),
      setDataFromString: describePropertyOwnership(value, "setDataFromString"),
      setName: describePropertyOwnership(value, "setName"),
...
export function captureReferenceBlobObjectSurface() {
