...
export function captureReferenceLoggerSurface() {
  ...
  return {
    type: typeof logger,
    properties: describeProperties(logger),
    prototypeIsObjectPrototype: Object.getPrototypeOf(logger) === Object.prototype,
    stringify: String(logger as any),
  };
}
